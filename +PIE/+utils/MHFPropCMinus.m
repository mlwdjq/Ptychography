...
function output = MHFPropCMinus(aperture, inCoordsX, inCoordsY, inCoordsZ, outCoordX, outCoordY, outCoordZ, wavelength)
...
idx = find(aperture);
tic;
output = MHFPropCmexMinus(aperture(idx), inCoordsX(idx), inCoordsY(idx), inCoordsZ(idx), ...
