...
pie.uieSegmentPath.set(fullfile(pie.cAppPath,  '..','+utils','segs.mat'));
...
switch scanningDim
    ...
    case '3D'
        % perform 3D scanning
        filename = fullfile(pie.cAppPath,  '..','..', 'data','scanning','squareScanning3D_19by4.mat');
        load(filename);
        pie.dPos_mm = dPos_mm;
...
for u8ModeId = 1:modeNumber
    ...
    objname = fullfile(pie.cAppPath,  '..','..', 'data','object','contact5_114.mat');
    load(objname);
